    ...
    header: MenuBar {
        ...
        Menu {
            ...
            Menu {
                title: "New Pipeline"
                Action {
                    text: "Photogrammetry (OpenCL)"
                    onTriggered: ensureSaved(function() { _reconstruction.new("photogrammetry") })
                }
                Action {
                    text: "Photogrammetry (CUDA)"
                    onTriggered: ensureSaved(function() { _reconstruction.new("photogrammetry-cuda") })
                }
                Action {
                    text: "Panorama HDR"
        ...
        Menu {
            title: "Help"
            Action {
                text: "MeshroomCL Documentation"
                onTriggered: Qt.openUrlExternally("https://github.com/openphotogrammetry/meshroomcl")
            }
            Action {
                text: "Meshroom Documentation"
                onTriggered: Qt.openUrlExternally("https://meshroom-manual.readthedocs.io")
            }
            Action {
                text: "About MeshroomCL"
