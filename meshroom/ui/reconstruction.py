...
class Reconstruction(UIGraph):
    ...
    activeNodeCategories = {
        "sfm": ["StructureFromMotion", "StructureFromMotionCL", "GlobalSfM", "PanoramaEstimation", "SfMTransfer", "SfMTransform",
                "SfMAlignment"],
    ...
    def new(self, pipeline=None):
        ...
        elif p.lower() == "photogrammetry-cuda":
            # default AliceVision photogrammetry pipeline
            self.setGraph(multiview.photogrammetryAliceVision())
