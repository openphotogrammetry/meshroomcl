...
class MeshroomApp(QApplication):
    ...
    def __init__(self, args):
        ...
        self.setOrganizationName('OpenPhotogrammetry')
        self.setApplicationName('MeshroomCL')
        ...
        return [
            {
                ...
                "onlineUrl": "https://raw.githubusercontent.com/openphotogrammetry/meshroomcl/main/COPYING.md"
            },
            {
                "title": "Meshroom",
                "localUrl": os.path.join(rootDir, "COPYING-Meshroom.md"),
